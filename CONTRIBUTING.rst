...
Report problems with the metabolic model at https://github.com/z-haiman/RBC-GEM/issues.
...
The best way to send feedback is to file an issue at https://github.com/z-haiman/RBC-GEM/issues.
...
Ready to contribute? Here's how to set up `RBC-GEM` for local development.

1. Fork the `RBC-GEM` repo on GitHub.
